...
const socialLinks: SocialLink[] = [
  { icon: Mail, href: "mailto:francis@example.com", label: "Email" },
  { icon: Linkedin, href: "https://linkedin.com/in/francis-pwavwe", label: "LinkedIn" },
    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-6 py-8 sm:flex-row sm:justify-between">
        <p className="text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} Francis Pwavwe. All rights reserved.
        </p>
